# HRFlow Remaining MVP Questions

Only four owner decisions remain. Everything else is deliberately fixed or excluded from the focused MVP.

| ID | Question | Recommended default |
|---|---|---|
| Q-001 | Confirm that HRFlow uses synthetic/demo data and is not used for real payroll. | Yes. |
