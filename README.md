...
HRFlow is a seven-calendar-day Django HR and payroll MVP built with synthetic data. The required demonstration flow is:
...
Create a local/demo administrator and run the application:
...
1. `AI_CONTEXT.md` — compact, binding instructions for coding agents.
...
5. `docs/delivery-plan.md` — current implementation status, sequence, ownership, and cut line.
...
8. `docs/team-ai-context-prompt.md` — ready-to-share teammate/AI project kickoff prompt.
